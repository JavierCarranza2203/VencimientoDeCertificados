    ...
    try {
        ...
        switch($Operacion) {
            ...
            case 'update':
                ...
                $usuarioRecibido = json_decode($data);

                echo json_encode($UsuarioService->ActualizarUsuario($usuarioRecibido->id, 
                                                                    $usuarioRecibido->nombre, 
                                                                    $usuarioRecibido->usuario, 
                                                                    $usuarioRecibido->grupoClientes, 
                                                                    $usuarioRecibido->rol));
            break;
            default:
